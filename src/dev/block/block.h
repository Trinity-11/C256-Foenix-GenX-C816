...
//
extern short bdev_read(short dev, long lba, byte * buffer, short size);
...
//
extern short bdev_write(short dev, long lba, const byte * buffer, short size);
...
//  0 on success, any negative number is an error code
//
extern short bdev_ioctrl(short dev, short command, byte * buffer, short size);
