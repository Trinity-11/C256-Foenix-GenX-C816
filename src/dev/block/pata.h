...
//
extern short pata_read(long lba, byte * buffer, short size);
...
//
extern short pata_write(long lba, const byte * buffer, short size);
...
//  0 on success, any negative number is an error code
//
extern short pata_ioctrl(short command, byte * buffer, short size);
