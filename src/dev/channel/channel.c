...
void cdev_init_system() {
    ...
    // Pre-open a channel for the console...
...
//
short chan_read(short channel, byte * buffer, short size) {
    p_channel chan;
    p_dev_chan cdev;
    short res;
...
//  number of bytes read, any negative number is an error code
//
short chan_readline(short channel, byte * buffer, short size) {
    p_channel chan;
    p_dev_chan cdev;
    short res;
...
//
short chan_write(short channel, const byte * buffer, short size) {
    p_channel chan;
    p_dev_chan cdev;
    short res;
...
//
short chan_write_b(short channel, byte b) {
    p_channel chan;
    p_dev_chan cdev;
    short res;
...
//  0 on success, any negative number is an error code
//
short chan_ioctrl(short channel, short command, byte * buffer, short size) {
    p_channel chan;
    p_dev_chan cdev;
    short res;
